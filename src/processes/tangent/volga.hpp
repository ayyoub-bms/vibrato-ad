...
public:
    VolgaTangent(shared_ptr<Process<T>> parent, shared_ptr<VegaTangent<T>> vegaTangent, State<T> initialState) : TangentProcess<T>(parent, initialState, "Volga Tangent process"), vegaProcess(vegaTangent) {}
